...
const DWDM_10G_40Di = () => { 
  ...
  let PartNumber = "NXO-H7-Dxx-40Di";
...
<div id="menu1" class="container tab-pane fade"><br/>
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXO-H7-Dxx-40D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXO-H7-Dxx-40Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXO-H7-Dxx-40D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>500</td>
        ...
        <tr>
          <td>Supply Current (NXO-H7-Dxx-40Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>500</td>
