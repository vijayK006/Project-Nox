...
<div className='resp-overflow'>
 ...
 NXO-A1-S13-30P 1x9 SIP package style transceivers are compliant with the industrial standard specification. The high performance uncooled 1310nm FP transmitter and high sensitivity PIN-TIA receiver provide superior performance for SONET OC3/ SDH STM1 and Ethernet applications up to 30km optical links with single mode fiber.
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tbody>
        ...
        {/* <tr>
          <td>Supply Voltage(NXO-Ax-S13-30P5) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+6.0</td>
          <td>V</td>
