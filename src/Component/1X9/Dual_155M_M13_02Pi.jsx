...
const Dual_155M_M13_02Pi = () => { 
  ...
  let PartNumber = "NXO-A1-M13-02Pi";
...
NXO-A1-M13-02P 1X9 SIP package style transceivers are compliant with the industrial standard specification. The high performance uncooled 1310nm FP transmitter and high sensitivity PIN receiver provide superior
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          <td>Supply Voltage(NXO-A1-M13-02P) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+4.5</td>
          <td>V</td>
        ...
        <tr>
          <td>Supply Voltage(NXO-A1-M13-02P5) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+6.0</td>
          <td>V</td>
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXO-A1-M13-02P)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXO-A1-M13-02Pi)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current(NXO-A1-M13-02P)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>200</td>
        ...
        <tr>
          <td>Supply Current(NXO-A1-M13-02Pi)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>250</td>
