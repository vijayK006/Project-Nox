                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Case Operating Temp. (NXOAOC-10G-SPSP-xxx-xx)</td>
                                            <td>Top</td>
                                            <td>0</td>
                                            <td>-</td>
                                            <td>+70</td>
                                        ...
                                        <tr>
                                            <td>Case Operating Temp. (NXOAOC-10G-SPSP-xxx-xxi)</td>
                                            <td>Top</td>
                                            <td>-40</td>
                                            <td>-</td>
                                            <td>+85</td>
                                        ...
                                        <tr>
                                            <td>Supply Current (NXOAOC-10G-SPSP-xxx-xx)</td>
                                            <td>Icc</td>
                                            <td></td>
                                            <td></td>
                                            <td>300</td>
                                        ...
                                        <tr>
                                            <td>Supply Current (NXOAOC-10G-SPSP-xxx-xxi)</td>
                                            <td>Icc</td>
                                            <td></td>
                                            <td></td>
                                            <td>330</td>
