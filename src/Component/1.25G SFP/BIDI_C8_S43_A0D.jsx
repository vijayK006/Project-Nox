...
const BIDI_C8_S43_A0D = () => { 

  let PartNumber = "NXO-C8-S43-A0D";
...
NXO-C8-S45-A0D Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXO-C8-S43-A0D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXO-C8-S43-A0Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXO-C8-S43-A0D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>270</td>
        ...
        <tr>
          <td>Supply Current (NXO-C8-S43-A0Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>300</td>
...
export default BIDI_C8_S43_A0D;