...
const CWDW_SFP_b34D = () => { 
  ...
  let PartNumber = "NXO-A7-Cxx-b34D";
...
NXO-A7-Cxx-b34D Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
...
{/*         
        <tr>
          <td>Supply Voltage(NXO-A7-Cxx-b34D5) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+6.0</td>
          <td>V</td>
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXO-A7-Cxx-b34D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXO-A7-Cxx-b34Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current(NXO-A7-Cxx-b34D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>270</td>
        ...
        <tr>
          <td>Supply Current(NXO-A7-Cxx-b34Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>300</td>
